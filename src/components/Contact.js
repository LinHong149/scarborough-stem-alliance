  ...
  return (
    <div className={`Contact border z-10 pt-12 pb-12 flex flex-col items-center justify-center gap-50 ${gradient} rounded-50 w-[calc(100vw-2rem)] mb-4 px-10 mr-auto ml-auto relative -left-20`}>
        ...
        <div className='flex gap-10 w-full justify-center'>
            <iframe className="rounded-[20px] aspect-[3/2] max-w-[50%] flex grow " id="gmap_canvas" src="https://maps.google.com/maps?q=200%20Fundy%20Bay%20Blvd,%20Scarborough,%20ON%20M1W%203G1&t=&z=15&ie=UTF8&iwloc=&output=embed"></iframe>
            <div className='flex flex-col w-fit max-w-[50%] gap-4'>
