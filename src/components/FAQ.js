...
const FAQItem = ({ faqItem, onClick }) => {
  ...
  return (
    <div 
    className={`FAQ-container flex flex-col ${isActive ? "gap-4": "gap-0"} border-white border-[3px] min-w-[300px] grow rounded-50 w-full [calc(50%-12.5px)] h-fit shrink p-9 transition-all duration-100 ease-in`}
    onClick={onClick}
    >
